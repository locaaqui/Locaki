...
foreach ($files as $file) {
  ...
  if (preg_match("#\<body.*\>(.*)\<\/body\>#si", $contents, $body_content)) { //getting content only between <body>        <!-- whatsapp flutuante -->
    ...
    <ol class="search-list">
      ...
      if (isset($_GET['liveSearch']) and $_GET['liveSearch'] != "" and $match_count != 0) {
        ...
        <li class="search-list-item-all">
          <a href='../../locaki2021/bat/search-results.html?s=<?php echo $_GET['s']; ?>&filter=<?php echo $search_filter_init; ?>'  class="search-submit">
            <?php
            echo "See other ";
            echo $sum_of_results;
